...
type HostQuarantineConfig struct {
	...
	Password string `json:"password" mapstructure:"password" yaml:"password" password:"true" desc:"Password for encrypting quarantined files (required to restore files later)"` //nolint:gosec // user password for quarantine
