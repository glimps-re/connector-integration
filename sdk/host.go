...
type HostConfig struct {
	...
	MaxFileSize           string               `json:"max_file_size" mapstructure:"max_file_size" yaml:"max_file_size" desc:"Maximum file size to scan directly (e.g., '100MB'). Files exceeding this are extracted if 'extract' is enabled, otherwise rejected"`
...
type HostQuarantineConfig struct {
	...
	Password string `json:"password" mapstructure:"password" yaml:"password" desc:"Password for encrypting quarantined files (required to restore files later)"`
